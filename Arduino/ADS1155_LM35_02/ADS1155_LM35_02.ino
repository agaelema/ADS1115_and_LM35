...
//  ads.setGain(GAIN_SIXTEEN);    // 16x gain  +/- 0.256V  1 bit = 0.125mV  0.0078125mV
  ...
  Serial.print("Nano volt/bit (5V): ");  Serial.print(nano_bit_Voltage_5v0 * 1000, 4);  Serial.println(" mV/bit");
  Serial.print("Nano volt/bit (1.1V): ");  Serial.print(nano_bit_Voltage_1v1 * 1000, 4);  Serial.println(" mV/bit");
  Serial.println();
  Serial.println();

  /* imprime a primeira linha com identificacao dos dados */
  Serial.println("ADS RAW \tADS Temp. \tNano RAW \tNano Temp. \tNano RAW Avg \tNano Temp. Avg");
...
void loop(void) 
{
  ...
  Serial.print(nano_ch0_0);   Serial.print("\t\t");   Serial.print(nano_Temperature_ch0_0, 3);  Serial.print("\t\t");
  Serial.print(nano_ch0_1);   Serial.print("\t\t");   Serial.print(nano_Temperature_ch0_1, 3);
  Serial.println();
